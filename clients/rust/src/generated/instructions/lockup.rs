...
impl Lockup {
  pub fn instruction(&self, args: LockupInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LockupInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
#[inline(always)]
    pub fn lockup_authority(&mut self, lockup_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Token owner
#[inline(always)]
    pub fn token_owner(&mut self, token_owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn depositor_token_account(&mut self, depositor_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Lockup pool
#[inline(always)]
    pub fn lockup_pool(&mut self, lockup_pool: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          token_owner: self.instruction.token_owner.expect("token_owner is not set"),
                  
          depositor_token_account: self.instruction.depositor_token_account.expect("depositor_token_account is not set"),
                  
          lockup_pool: self.instruction.lockup_pool.expect("lockup_pool is not set"),
