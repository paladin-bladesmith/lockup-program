...
impl WithdrawBuilder {
    ...
    /// Lamport destination
    #[inline(always)]
    pub fn lamport_destination(
        &mut self,
        lamport_destination: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn token_destination(
        &mut self,
        token_destination: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = Withdraw {
            ...
            lamport_destination: self
                .lamport_destination
                .expect("lamport_destination is not set"),
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
    ...
    pub fn lamport_destination(
        &mut self,
        lamport_destination: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn token_destination(
        &mut self,
        token_destination: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
